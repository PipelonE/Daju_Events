...
export const Navbar = () => {
    ...
    return (
        <header className="cabecera" id="cabecera" ref={refheader} style={{backgroundColor: background}}>
            ...
            <ul className="menu">
                <li className="item"><i href="/quienes_somos"><Link to="/quienes_somos">Registro</Link></i></li>
                <li className="item"><i href="/productos"><Link to="/productos">Mis Eventos</Link></i></li>
